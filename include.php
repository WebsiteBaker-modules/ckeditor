...
function show_wysiwyg_editor($name, $id, $content, $width = '100%', $height = '250px', $toolbar = false) {
  ...
  $ckeditor->config['defaultLanguage']  = 'en';
     ...
     *
     */
    $ckeditor->config['extraPlugins'] = 'justify,find,flash,colorbutton,colordialog,dialogadvtab,div,font,forms,iframe,indentblock,language,bidi,liststyle,pagebreak,save,selectall,showblocks,smiley,templates,codemirror,wblink,wbdroplets,shybutton,youtube,oembed,backup,wbsave';
    $ckeditor->config['removePlugins'] = 'wsc,link,save,newpage,print,syntaxhighlight,preview';
